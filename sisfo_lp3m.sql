...
--
-- Host: localhost
-- Generation Time: Aug 27, 2020 at 06:46 PM
...
INSERT INTO `laporan` (`id_laporan`, `standar_id`, `nama_laporan`, `unit_laporan`, `thn_akademik`, `semester`, `tahun_laporan`, `penyusun_laporan`, `tgl_pengesahan`, `vol`, `sifat`, `jenis_laporan`, `kategori_laporan`, `file`, `user_id`, `timestamp_laporan`) VALUES
(2, 6, '2', '2', '2', '2', 2, '2', '0002-02-04', '2', '2', '2', '2', 'APLIKASI_PELAYANAN_PUBLIK_PADA_KANTOR_KELURAHAN_BERBASIS_ANDROID_(Studi_Kasus_di_Kabupaten_Karawang).pdf', 28, '2020-07-19 15:42:28');
...
(1, '28202007131594653332', 6, '1', '1', 'Ganjil', 'UAS', 28, 1, 2, 4, '2020-08-09 14:13:50');
...
INSERT INTO `pendidikan_aspek` (`id_aspek_pendidikan`, `penilaian_id`, `standar_id`, `aspek`, `indikator`, `bobot`, `target_aspek`, `aspek_timestamp`) VALUES
(1, 1, 27, 'Pembimbingan akademik (perwalian) dilakukan paling sedikit 3 (tiga) kali setiap semester', 'Presentase  rata2 pertemuan dosen membimbuing\r\n=((Rata2 jumlah pertemuan bimbingan akademik) / 3 ) x 100%', '1,7', 100, '2020-05-07 07:43:48'),
(2, 1, 27, 'Dosen Pembimbing Akademik  melaksanakan pembimbingan akademik yang sesuai dengan panduan  PA', 'Presentase penyeiapan  kelengkapan administrasi </br>\r\n0 % = belum  dokumen </br>\r\n25% = proses menyusun dokumen </br>\r\n50% = dokumen sudah lengkap </br>\r\n75% = dokumen disahkan </br>\r\n100% = dokumen  disosialisasikan </br>', '1,7', 100, '2020-05-07 07:46:07'),
(3, 3, 27, 'Dosen menyusun Rencana Pembelajaran Semester (RPS) dengan kedalaman dan keluasan sesuai dengan capaian pembelajaran lulusan setiap semester', 'Presentase Jumlah RPS (JRPS)\r\n= (Jumlah realisasi RPS per MK/Jumlah MK) x 100%', '1,7', 50, '2020-05-07 07:47:02'),
(4, 4, 27, 'Dosen menyusun materi  pembelajaran sesuai dengan Rencana Pembelajaran Semester (RPS)', 'Presentase materi pembelajaran \r\n= ((jumlah realisasi materi pembelajaran)/jumlah mata kuliah )x 100%', '1,7', 100, '2020-05-07 07:48:20'),
(5, 5, 27, 'Dosen  melaksanakan proses pembelajaran sesuai RPS', 'Jumlah Presentase kesesuaian Materi kuliah dengan RPS\r\nSkor : </br>\r\n0% = Jika tidak ada bukti yg sahih adanya sistem dan pelaksanaan pemantauan proses pembelajaran</br>\r\n10% - 55% = Ada bukti yg sahih adanya sistem  pemantauan proses pembelajaran  namun tidak dilaksanakan secara konsisten</br>\r\n56% = Ada bukti yg sahih adanya sistem pemantauan proses pembelajaran   yang dilaksanakan secara periodik untuk mengukur kesesuaian RPS</br>\r\n65% = Ada bukti yg sahih adanya sistem pemantauan proses pembelajaran   yang dilaksanakan secara periodic untuk mengukur kesesuaian RPS dan hasil monev terdokumentasi dengan baik</br>\r\n80% = Ada bukti yg sahih adanya sistem pemantauan proses pembelajaran   yang dilaksanakan secara periodic untuk mengukur kesesuaian RPS dan hasil monev terdokumentasi dengan baik dan digunakan untuk perbaikan mutu proses pembelajaran</br>\r\n', '1,7', 100, '2020-05-07 07:48:44'),
(6, 6, 27, 'Dosen  wajib hadir memberikan kuliah untuk setiap mata kuliah yang diampunya  14 kali ditambah UTS dan UAS setiap semester', 'Rata-rata kehadiran dosen mengajar rata-rata kehadiran dosen mengawas UTS dan UAS', '1,7', 100, '2020-05-07 07:49:12'),
(7, 6, 27, 'Program Studi menyelenggarakan Ujian Tengah Semester setelah perkuliahan minggu ke 7, dan menyelenggarakan Ujian Akhir Semester setelah perkuliahan minggu ke 14.', 'Presentase pelaksanaan proses pembelajaran </br>\r\n0 % = tidak terlaksana </br>\r\n25% = terlaksana 25% </br>\r\n50% = terlaksana 50% </br>\r\n75% = terlaksana 75% </br>\r\n100% = terlaksana 100% </br>\r\nSejumlah banyaknya pertemuan </br>', '0,59', 100, '2020-05-07 07:49:55'),
(8, 6, 27, 'Dosen menyusun soal ujian dengan baik dan  sesuai dengan RPS.', '=(Soal yang sesuai sudah diperiksa oleh  tim reviewer soal/jumlah soal) x 100%', '1,7', 100, '2020-05-07 07:50:30'),
(9, 2, 27, 'Prodi Menyelenggarakan tugas akhir dengan menggunakan bentuk pembelajaran berupa penelitian, perancangan atau pengembangan', 'Presentase mahasiswa yang telah menyelesaikan Tugas Akhir = (Jumlah mahasiswa yang lulus TA/Jumlah mahasiswa yang mengajukan TA) x 100%', '1,7', 100, '2020-05-07 07:50:49'),
(10, 0, 27, 'Setiap tahun seorang dosen wajib membimbing tugas akhir paling banyak 8 (delapan) orang mahasiswa.', 'Rata-rata jumlah bimbingan TA = (Jumlah Mahasiswa TA )/jumlah dosen', '1,7', 100, '2020-05-03 11:35:01'),
(11, 7, 27, 'Mahasiswa menyelesaikan penulisan tugas akhir dalam kurun waktu 4 (empat) sampai dengan 12 (dua belas) bulan', 'Rata-rata waktu penyelesaian TA = (jumlah waktu penyelesaian TA per prodi)/jumlah mahasiswa TA', '1,7', 100, '2020-05-07 08:01:43'),
(12, 0, 27, 'Program Studi menyelenggarakan sidang Tugas Akhir Secara terjadwal untuk Seluruh mahasiswa yang telah menyelesaikan penulisan tugas akhir.', '-', '-', 100, '2020-05-03 11:37:28');
...
(1580, 28, 'has been login from 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-07-25 05:41:31'),
(1581, 28, 'open Profil ', '2020-07-25 05:41:31'),
(1582, 28, 'open Profil ', '2020-07-25 05:44:08'),
(1583, 28, 'open Profil ', '2020-07-25 05:44:44'),
(1584, 28, 'open Profil ', '2020-07-25 05:45:52'),
(1585, 28, 'open Profil ', '2020-07-25 05:46:14'),
(1586, 28, 'open Profil ', '2020-07-25 05:46:29'),
(1587, 28, 'open Profil ', '2020-07-25 05:46:46'),
(1588, 28, 'open Profil ', '2020-07-25 05:47:00'),
(1589, 28, 'logged out of the address 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-07-25
address 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-02 16:42:01'),
(1644, 28, 'has been login from 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-02 16:42:06'),
(1645, 28, 'open Profil ', '2020-08-02 16:42:07'),
(1646, 28, 'has been login from 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-03 14:17:49'),
(1647, 28, 'open Profil ', '2020-08-03 14:17:49'),
(1648, 28, 'open aspek ', '2020-08-03 14:17:52'),
(1649, 28, 'open Nota Dinas ', '2020-08-03 14:34:17'),
(1650, 28, 'logged out of the address 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-03 14:35:25'),
(1651, 9, 'has logged in from the address 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-03 14:35:35'),
(1652, 9, 'open Profil ', '2020-08-03 14:35:35'),
(1653, 9, 'open Submenu ', '2020-08-03 14:35:41'),
(1654, 9, 'add Submenu Array', '2020-08-03 14:36:06'),
(1655, 9, 'open Submenu ', '2020-08-03 14:36:06'),
(1656, 9, 'open Submenu ', '2020-08-03 14:36:24'),
(1657, 9, 'open Submenu ', '2020-08-03 14:36:48'),
(1658, 9, 'update submenu Array138', '2020-08-03 14:36:58'),
(1659, 9, 'open Submenu ', '2020-08-03 14:36:58'),
(1660, 9, 'delete submenu 138', '2020-08-03 14:37:24'),
(1661, 9, 'open Submenu ', '2020-08-03 14:37:24'),
(1662, 9, 'logged out of the address 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-03 14:44:23'),
(1663, 28, 'has been login from 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-03 14:44:30'),
(1664, 28, 'open Profil ', '2020-08-03 14:44:31'),
(1665, 28, 'open PelaksanaanPendidikan ', '2020-08-03 14:44:38'),
(1666, 28, 'open DetailPendidikanPelaksanaan 1', '2020-08-03 14:44:42'),
(1667, 28, 'open PelaksanaanPendidikan ', '2020-08-03 14:45:22'),
(1668, 28, 'open DetailPendidikanPelaksanaan 1', '2020-08-03 14:45:31'),
(1669, 28, 'has been login from 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-05 14:07:05'),
(1670, 28, 'open Profil ', '2020-08-05 14:07:06'),
(1671, 28, 'has been login from 127.0.0.1 using Firefox 78.0 os Mac OS X', '2020-08-09 14:13:33'),
(1672, 28, 'open Profil ', '2020-08-09 14:13:33'),
(1673, 28, 'open PeningkatanPendidikan ', '2020-08-09 14:13:35'),
(1674, 28, 'open Pendidikan ', '2020-08-09 14:13:39'),
(1675, 28, 'has updated the data in the Pendidikan table 1 1 Ganjil UAS 1 2', '2020-08-09 14:13:50'),
(1676, 28, 'open Pendidikan ', '2020-08-09 14:13:50'),
(1677, 28, 'open PeningkatanPendidikan ', '2020-08-09 14:13:53'),
(1678, 28, 'open ReportPeningkatan 1', '2020-08-09 14:13:57'),
(1679, 28, 'open PeningkatanPendidikan ', '2020-08-09 14:14:01'),
(1680, 28, 'open MutuPeningkatan ', '2020-08-09 14:14:04');
...
(137, 1, 'Panduan Penggunaan', 'Profil/sop', 1);
...
--
ALTER TABLE `pendidikan_aspek`
  MODIFY `id_aspek_pendidikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `user_log`
  MODIFY `id_user_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1681;
